...
def Bilater(image,I_2,gsigma,ssigma,winsize):
    r = int(winsize/2)
    c = r
    image1 = np.pad(image, ((r, c),(r, c)), constant_values=0)      #对边缘进行填充
...
img_path = '/mnt/data3/fizz/AllDataset/RDD/test/gt/'
...
for i in range(0,len(paths)):
    ...
    cv2.imwrite('/mnt/data3/fizz/AllDataset/RDD/test/back_gt/{:s}'.format(path), bilater_image_2)
    print(path)
